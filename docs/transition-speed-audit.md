...
1. Complete the irreducible real-state preflight gates: optional-user modes not installed on this console, a real second UID, first-ever save creation, game-card removal/update, sleep/wake between prepare and launch, and a failed launch. The RAM-only baseline plus all seven rejection branches pass.
